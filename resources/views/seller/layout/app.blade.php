...
<body>
    <div class="flex h-screen bg-slate-900" :class="{ 'overflow-hidden': isSideMenuOpen }">

        <!-- Desktop sidebar -->
        <aside class="z-20 flex-shrink-0 hidden w-60 pl-2 overflow-y-auto bg-slate-900 md:block">
            <div>
                <div class="text-white">
                    <div class="flex p-2  bg-slate-900">
                        <div class="flex py-3 px-2 items-center">
                            <p class="text-2xl text-green-500 font-semibold">Seller</p <p class="ml-2 font-semibold italic">
                            DASHBOARD</p></br><p class="ml-2 font-semibold italic">
                              From</p>
                        </div>
                    </div>
                    <div class="flex justify-center">
                        <div class="">
                            <img class="hidden h-24 w-24 rounded-full sm:block object-cover mr-2 border-4 border-green-400"
                                src="{{ asset('images/lookin_web.png') }}" alt="">
                            <p class="font-bold text-base  text-gray-400 pt-2 text-center w-24">Lookin Dharamshala</p>
                        </div>
                    </div>
                    <div>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="add_service_details"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Buisness Listing </a>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="manage_service_details"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Manage Buisness </a>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="#"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Add Blogs</a>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="#"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">Check Service </a>
        ...
        <aside
            class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto  bg-gray-900 dark:bg-slate-900 md:hidden"
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto">
            <header class="z-40 py-4  bg-slate-900  ">
