...
<div class="p-4  rounded-lg  border-2 border-slate-900 border-dashed h-auto">
    ...
    <div class="w-full p-4 ">
      ...
      <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2">Upload Blogs Gallery </p>
      <div class="h-full  w-full  flex flex-col  items-center justify-center ">
        ...
        {{-- form starts --}}
          <form action="{{url('upload_blogs_gallery/'.$id)}}" method="post" method="post" enctype="multipart/form-data" class="lg:w-3/4 md:w-3/4 sm:w-3/4 w-full bg-white p-4  rounded-lg shadow-lg  ">
