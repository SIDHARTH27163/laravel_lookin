...
{{-- blogs add ends --}}
    ...
    <div class="w-full p-4 ">
      ...
      <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2">Add Blogs Location</p>
      <div class="h-full  w-full  flex flex-col  items-center justify-center ">
       ...
       {{-- form for add location starts --}}
          <form action="add_loc" method="post" class="lg:w-3/4 md:w-3/4 sm:w-3/4 w-full bg-white p-4  rounded-lg shadow-lg  ">
              @csrf  
              @method('post') 
              <div class="mb-4">
                <label for="email" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Add Blogs Location</label>
  ...
  @endif
   ...
   <div class="w-full p-4 ">
      ...
      <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2">Added Blogs Location</p>
   ...
   <table class="w-full text-sm text-left text-gray-500 ">
       ...
       <tbody>
         ...
         <tr class=" border-b bg-gray-900 border-gray-700">
            ...
            <td class="px-6 py-4">
                <a href="{{url('delete_loc/'.$location->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</a>
