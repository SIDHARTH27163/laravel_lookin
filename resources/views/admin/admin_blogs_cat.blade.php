...
<div class="p-4  rounded-lg  border-2 border-slate-900 border-dashed h-auto">
    ...
    <div class="w-full p-4 ">
      ...
      <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2">Add Blogs Category</p>
      <div class="h-full  w-full  flex flex-col  items-center justify-center ">
         ...
         <div class="flex items-start  w-full justify-start">
          ...
          {{-- message Block ends --}}
        {{-- form starts --}}
          <form action="add_cat" method="post" class="lg:w-3/4 md:w-3/4 sm:w-3/4 w-full bg-white p-4  rounded-lg shadow-lg  ">
              @csrf  
              @method('post') 
              <div class="mb-4">
                <label for="email" class="block mb-2 text-lg font-medium text-gray-900 dark:text-white">Add Blogs Category</label>
                <input type="text" name="category" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="eg:Bhagsu , Kareri etc">
  ...
  @endif
   ...
   <div class="w-full p-4 ">
      ...
      <p class="toggleColour text-gray-900 text-2xl  font-bold underline py-2">Added Blogs Category</p>
         ...
         <table class="w-full text-sm text-left text-gray-500 ">
             ...
             <tbody>
               ...
               <tr class=" border-b bg-gray-900 border-gray-700">
                  ...
                  <td class="px-6 py-4">
                     <a href="{{url('delete_cat/'.$cat->id)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</a>
