...
<a href="/filter_blogs/{{ $cat->category }}" class="block w-full px-1 text-lg font-normal py-1  cursor-pointer hover:bg-gray-100 text-blue-700 hover:rounded-lg hover:shadow-lg ">
   {{ $cat->category }}
    </a>
@endforeach
...
Download
         ...
         <li>
            ...
            <div id="accordion-collapse" data-accordion="collapse">
                ...
                <div id="accordion-collapse-body-2" class="hidden bg-white" aria-labelledby="accordion-collapse-heading-1">
...
<div class="w-48 text-sm font-medium text-gray-900  rounded-lg ">
    ...
    <a href="/filter_blogs/{{ $location->location }}" class="block w-full px-1 text-lg font-normal py-1 cursor-pointer hover:bg-gray-100 text-blue-700 hover:rounded-lg hover:shadow-lg ">
        {{ $location->location }}
        </a>
    @endforeach
</div>
